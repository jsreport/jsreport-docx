  ...
  it("image can render from url", async () => {
    return reporter
      .render({
        ...
        data: {
          src:
            "http://www.thoughtco.com/thmb/A44MJKvbYVDVXz5uh1YtnD_bY3E=/768x0/filters:no_upscale():max_bytes(150000):strip_icc()/PaleoJournaling-56c4bb085f9b58e9f32cfe72.jpg"
        }
      })
